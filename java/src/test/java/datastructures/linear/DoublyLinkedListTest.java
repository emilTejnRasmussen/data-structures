...
class DoublyLinkedListTest
{
    ...
    class Set
    {
        ...
        {
            Integer previous = list.set(2, 99);
    ...
    class Remove
    {
        ...
        @Test
        void shouldMaintainLinksAfterRemovingMiddleElement()
        {
            list.add(40);
            list.remove(2);
        ...
        @Test
        void shouldMaintainTailAfterRemovingLastElement()
        {
            list.remove(2);
            list.add(40);
